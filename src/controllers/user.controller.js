...
const generateAccessAndRefreshTokens = async (UserId) => {
  try {
    ...
    throw new ApiError(
      500,
      "Something went wrong while generating and accessing token"
    );
  }
};
...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // Uncomment the following block if you want to validate that fullName is not empty
  // if(fullName === "") {
...
const logoutUser = asyncHandler(async (req, res, next) => {
  //use middleware design on our own
...
//to update files user multer as middleware
